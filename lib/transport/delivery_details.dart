                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          _buildMenu("Chat", 0),
                          _buildMenu("Delivery Detail", 2),
                          _buildMenu("Driver List", 1),
                        ],
                      ),
                      AnimatedContainer(
  ...
  Widget _buildMenu(String menu, int index) {
    return GestureDetector(
      onTap: () {
        ...
        index == 1 ?Navigator.push(context, MaterialPageRoute(builder: (context)=> transporter_dashboard())):delivery_details();
      },
      child: Container(
        width: 150,
