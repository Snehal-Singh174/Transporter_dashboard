...
class delivery_details_completed extends StatefulWidget {
  @override
  _delivery_details_completedState createState() => _delivery_details_completedState();
}

class _delivery_details_completedState extends State<delivery_details_completed> {
  var paddingLeft = 0.0;
  @override
              ...
              Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> delivery_details_progress()));},
